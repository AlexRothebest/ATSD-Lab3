...
namespace Lab3
{
    class BinaryMinHeap
    {
        ...
        public BinaryMinHeap(params int[] values)
        {
        ...
        public static BinaryMinHeap DeleteTop(BinaryMinHeap x)
        {
            if (x.Head == null)
            {
                Console.WriteLine("The heap is empty, impossible to delete root element");
            ...
            BinaryMinHeap HeapToReturn = new BinaryMinHeap(x.Head.Data);
            x.DeleteRoot();
            return HeapToReturn;
        }
        ...
        public object this[int Index]
        {
            get
            {
                ...
                Node CurrentNode = Head;
                string CountBinary = Convert.ToString(Index + 1, 2).Substring(1);
                foreach (char i in CountBinary)
                {
                    if (i == '0')
                    {
